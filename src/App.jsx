...
const App = () => {
  ...
  return <main className={`w-full`} style={{backgroundColor : secondary}}>
    ...
    <h1 className="text-center font-bold text-4xl py-8">ColorPulse</h1>
    <button  className=" border-transparent text-xl rounded-xl px-6 py-4" style={{backgroundColor : primaryButton}}>Contact Me</button>
    </div>
